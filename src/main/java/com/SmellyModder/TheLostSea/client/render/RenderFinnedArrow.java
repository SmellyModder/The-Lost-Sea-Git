...
public class RenderFinnedArrow <T extends EntityFinnedArrow> extends Render<T>
{
	
	private static final ResourceLocation[] TEXTURES = new ResourceLocation[] {new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/finnedarrowentity.png"), new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/cobaltfinnedarrowentity.png")};
	
	public RenderFinnedArrow(RenderManager renderManagerIn)
    {
	...
	protected ResourceLocation getEntityTexture(T entity) {
		return TEXTURES[entity.getFinnedArrowType().ordinal()];
	}
}
