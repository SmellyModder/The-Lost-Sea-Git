package com.SmellyModder.TheLostSea.client.render.atlantis;

import com.SmellyModder.TheLostSea.client.model.atlantis.ModelTitan;
...
public class RenderTitan extends RenderLiving<EntityTitanGuardian> {

	public static final ResourceLocation[] TEXTURES = new ResourceLocation[]{new ResourceLocation(Reference.MOD_ID + ":textures/entity/atlantis/titan_sword.png"), new ResourceLocation(Reference.MOD_ID + ":textures/entity/atlantis/titan_gauntlet.png"), new ResourceLocation(Reference.MOD_ID + ":textures/entity/atlantis/titan_bow.png")};
	private static final ResourceLocation GUARDIAN_BEAM_TEXTURE = new ResourceLocation("textures/entity/guardian_beam.png");
	
    public RenderTitan(RenderManager manager) {
        super(manager, new ModelTitan(), 0.9F);
       // this.addLayer(new LayerGlow<EntityTitan>(this, new ResourceLocation("thelostsea:textures/entity/layer/anglerfish_overlay.png")));
    }

    @Override
	protected ResourceLocation getEntityTexture(EntityTitanGuardian entity) {
		return TEXTURES[entity.getVariant()];
	}
    public boolean shouldRender(EntityTitanGuardian livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
     ...
     */
    public void doRender(EntityTitanGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            double d0 = vec3d2.lengthSquared() + 1.0D;
