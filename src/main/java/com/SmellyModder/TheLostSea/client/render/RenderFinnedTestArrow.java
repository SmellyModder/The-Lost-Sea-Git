...
public class RenderFinnedTestArrow <T extends EntityFinnedArrowTest> extends Render<T>
{
	
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/finnedarrowentity.png");
	
	public RenderFinnedTestArrow(RenderManager renderManagerIn)
    {
