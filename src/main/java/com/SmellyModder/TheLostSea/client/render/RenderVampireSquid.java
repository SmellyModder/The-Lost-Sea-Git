...
public class RenderVampireSquid extends RenderLiving<EntityVampireSquid> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/vampire_squid.png");
    private static final ResourceLocation TONGUE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/layer/tongue.png");

    public RenderVampireSquid(RenderManager manager) {
        super(manager, new ModelVampireSquid(), 0.4F);
        this.addLayer(new LayerGlow<EntityVampireSquid>(this, new ResourceLocation("thelostsea:textures/entity/layer/squid_eyes.png")));
    }

	@Override
	protected ResourceLocation getEntityTexture(EntityVampireSquid entity) {
		return TEXTURE;
	}
	
	@Override
	protected void preRenderCallback(EntityVampireSquid entity, float f) {
	...
	public boolean shouldRender(EntityVampireSquid livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
     ...
     */
    public void doRender(EntityVampireSquid entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            float f7 = f * f;
            int j = 64 + (int)(f7 * 120.0F);
            int k = 32 + (int)(f7 * 120.0F);
