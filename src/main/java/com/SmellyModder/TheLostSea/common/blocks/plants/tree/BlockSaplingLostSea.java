...
public class BlockSaplingLostSea extends BlockBush implements IGrowable, IHasModel {
	...
	public BlockSaplingLostSea(String name, WorldGenerator saplingGenerator, boolean isPalm) {
