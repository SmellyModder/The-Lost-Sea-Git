...
public class EntityTriGuardian extends EntityMob{

	 private static final DataParameter<Boolean> MOVING = EntityDataManager.<Boolean>createKey(EntityTriGuardian.class, DataSerializers.BOOLEAN);
	    private static final DataParameter<Integer> TARGET_ENTITY = EntityDataManager.<Integer>createKey(EntityTriGuardian.class, DataSerializers.VARINT);
	    ...
	    public EntityTriGuardian(World worldIn)
	    {
	        super(worldIn);
	        this.experienceValue = 10;
	        this.setSize(1.35F, 0.85F);
	        this.moveHelper = new EntityTriGuardian.TriGuardianMoveHelper(this);
	    ...
	    protected void initEntityAI()
	    {
	        ...
	        this.tasks.addTask(4, new EntityTriGuardian.AITriGuardianAttack(this));
	        this.tasks.addTask(5, entityaimovetowardsrestriction);
	        this.tasks.addTask(7, this.wander);
	        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
	        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityGuardian.class, 12.0F, 0.01F));
	        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityTriGuardian.class, 12.0F, 0.02F));
	        this.tasks.addTask(9, new EntityAILookIdle(this));
	        this.wander.setMutexBits(3);
	        entityaimovetowardsrestriction.setMutexBits(3);
	        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityLivingBase.class, 10, true, false, new EntityTriGuardian.TriGuardianTargetSelector(this)));
	    }
	    ...
	    {
	        EntityLiving.registerFixesMob(fixer, EntityTriGuardian.class);
	    }
	    ...
	    static class AITriGuardianAttack extends EntityAIBase
        {
            private final EntityTriGuardian guardian;
            private int tickCounter;

            public AITriGuardianAttack(EntityTriGuardian guardian)
            {
	    ...
	    static class TriGuardianMoveHelper extends EntityMoveHelper
        {
            private final EntityTriGuardian entityGuardian;

            public TriGuardianMoveHelper(EntityTriGuardian guardian)
            {
                super(guardian);
    ...
    static class TriGuardianTargetSelector implements Predicate<EntityLivingBase>{
    
    	private final EntityTriGuardian parentEntity;

            public TriGuardianTargetSelector(EntityTriGuardian guardian)
            {
