...
public abstract class LSProjectile extends Entity implements IProjectile
{
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public LSProjectile(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public LSProjectile(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public LSProjectile(World worldIn, EntityLivingBase throwerIn)
    {
