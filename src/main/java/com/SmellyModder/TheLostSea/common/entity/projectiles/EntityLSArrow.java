...
public class EntityLSArrow extends EntityArrow implements IThrowableEntity{

	public EntityLSArrow(World worldIn) {
		super(worldIn);
	}

	public EntityLSArrow(World worldIn, EntityLivingBase shooter) {
