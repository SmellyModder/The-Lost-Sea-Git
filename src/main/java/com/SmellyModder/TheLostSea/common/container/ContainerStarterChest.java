...
public class ContainerStarterChest extends Container
{
    private final IInventory lowerChestInventory;
    private final int numRows;

    public ContainerStarterChest(IInventory playerInventory, IInventory chestInventory, EntityPlayer player)
    {
