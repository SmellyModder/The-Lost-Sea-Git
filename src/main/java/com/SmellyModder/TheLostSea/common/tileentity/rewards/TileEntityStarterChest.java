...
public class TileEntityStarterChest extends TileEntityLockableLoot implements ITickable
{
    private NonNullList<ItemStack> chestContents = NonNullList.<ItemStack>withSize(27, ItemStack.EMPTY);
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStarterChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStarterChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStarterChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStarterChest adjacentChestZPos;
    ...
    public TileEntityStarterChest()
    {
    }

    public TileEntityStarterChest(BlockChest.Type typeIn)
    {
    ...
    {
        return this.hasCustomName() ? this.customName : "tile.lostsea.starter_chest.name";
    }

    public static void registerFixesChest(DataFixer fixer)
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityStarterChest.class, new String[] {"Items"}));
    }
    ...
    private void setNeighbor(TileEntityStarterChest chestTe, EnumFacing side)
    {
    ...
    @Nullable
    protected TileEntityStarterChest getAdjacentChest(EnumFacing side)
    {
        ...
        if (this.isChestAt(blockpos))
        {
            ...
            {
                TileEntityStarterChest TileEntityStarterChest = (TileEntityStarterChest)tileentity;
                TileEntityStarterChest.setNeighbor(this, side.getOpposite());
                return TileEntityStarterChest;
            }
        }
    ...
    public void update()
    {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null)
        {
            ...
            this.world.playSound((EntityPlayer)null, d1, (double)j + 0.5D, d2, SoundEvents.BLOCK_IRON_TRAPDOOR_OPEN, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F)
        {
            ...
            if (this.lidAngle < 0.5F && f2 >= 0.5F && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null)
            {
                ...
                this.world.playSound((EntityPlayer)null, d3, (double)j + 0.5D, d0, SoundEvents.BLOCK_IRON_TRAPDOOR_CLOSE, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
            }
