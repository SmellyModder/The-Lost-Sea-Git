...
public class TileEntitySeaStoneFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
	  ...
	  public void update()
	  {
	    ...
	    boolean flag1 = false;
	    final AxisAlignedBB BOUNDS = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 2.0D, 1.5D, 2.0D);
	    ...
	    if (!this.world.isRemote)
	    {
	      ...
	      {
	        flag1 = true;
	        BlockSeaFurnace.setState(this.isBurning(), this.world, this.pos);
	      }
