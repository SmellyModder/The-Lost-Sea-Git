...
public class ChunkGenLS implements IChunkGenerator
{
	protected static final IBlockState AIR = Blocks.WATER.getDefaultState();
    protected static final IBlockState NETHERRACK = TLSBlocks.SEA_ROCK.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    protected static final IBlockState LAVA = Blocks.SAND.getDefaultState();
    //protected static final IBlockState GRAVEL = TLSBlocks.LIQUIDACK.getDefaultState();
    protected static final IBlockState SOUL_SAND = Blocks.DIRT.getDefaultState();
    ...
    public ChunkGenLS(World worldIn, boolean p_i45637_2_, long seed)
    {
        this.world = worldIn;
