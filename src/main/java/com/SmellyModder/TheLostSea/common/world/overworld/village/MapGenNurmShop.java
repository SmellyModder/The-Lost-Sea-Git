...
/*
 * Mostly a Vanilla copy, used it for experimenting and had no luck :/
 */
public class MapGenNurmShop extends MapGenStructure
{
    /** A list of all the biomes villages can spawn in. */
    public static List<Biome> VILLAGE_SPAWN_BIOMES = Arrays.<Biome>asList(Biomes.PLAINS, Biomes.BEACH, Biomes.TAIGA);
    ...
    {
        return new MapGenNurmShop.Start(this.world, this.rand, chunkX, chunkZ, this.size);
    }
    ...
    public static class Start extends StructureStart
        {
            ...
            public Start(World worldIn, Random rand, int x, int z, int size)
            {
                ...
                StructureVillagePieces.Start structurevillagepieces$nurmshop = new StructureVillagePieces.Start(worldIn.getBiomeProvider(), 0, rand, (x << 4) + 2, (z << 4) + 2, list, size);
                
                this.components.add(structurevillagepieces$start);
                this.components.add(structurevillagepieces$nurmshop);
