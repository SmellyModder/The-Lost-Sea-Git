...
import com.SmellyModder.TheLostSea.common.world.overworld.village.MapGenNurmShop;
...
public class LSVillageHandler {
	...
	public static void initNurmShop()
	{
		...
		//MapGenStructureIO.registerStructure(MapGenNurmShop.Start.class, Reference.MOD_ID + ":nurm_vilage");
	}
}
